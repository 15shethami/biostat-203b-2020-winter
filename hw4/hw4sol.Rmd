...
Now we want to restrict to pneumonia patients. To find all possible ICD-9 codes related to heart attack, we search for string `pneumonia` in the `long_title` of table `d_icd_diagnoses`:
```{r}
