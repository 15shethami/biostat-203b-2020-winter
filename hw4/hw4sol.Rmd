...
final_cohort[,columns] <- lapply(final_cohort[, columns], as.factor)

## set the seed to make partition reproducible
set.seed(12345)

## create train and test set
train_ind <- sample(seq_len(nrow(final_cohort)), size = smp_size)
train <- final_cohort[train_ind, ]
test <- final_cohort[-train_ind, ]
...
dim(x_train)
y_train <- train %>% select("mortality")
