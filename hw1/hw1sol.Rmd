...
**Solution:** Let's display the number of times each of the four characters (Elizabeth, Jane, Lydia, and Darcy) is mentioned respectively <!-- how to get the names displayed next to the number, do not add to git will this be reproducible --> 
```{bash}
