...
ncov_tbl %>%
  ...
  #                     name = "") +
  scale_fill_gradientn(colors = wes_palette("Zissou1", n = 100, type = "continuous"),
...
```{r}
library(quantmod)
#"^HSI", Dow Jones (^DJI), NASDAQ (^IXIC), Russell 2000 (^RUT), FTSE 100 (^FTSE), Nikkei 225 (^N225), #HANG SENG INDEX (^HSI)
...
animate(stock, renderer = gifski_renderer())
