...
The plot depicts that most patients stay in ICU for 2-5 days with a range of approximately 40 days. 
...
Let's extract patient demographic information from `ADMISSION.csv` and combine it with the previously formed tibble by matching observations from patient demographics to previous tibble  
